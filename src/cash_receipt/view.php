<?php
	class view_cash_receipt{
		...
		function data_view($db,$e,$library_class,$code){
			...
			if(mysqli_num_rows($view_cash_receipt)>0 && $_SESSION['cash_receipt']==1 && !empty($_SESSION['bank'])){
				...
				<div class="app-card-header p-3 main-content container-fluid">
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
						...
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-3">
								<select id="type_of_receipt" name="type_of_receipt" class="form-control square" disabled="disabled" required>
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<input type="text" name="dari" id="dari" value="<?php echo $v['dari']; ?>" class="form-control square" required="required" disabled="disabled">
							</div>
							<div class="col-sm-2 col-lg-2" align="right">
								Account Name
							</div>
						...
						<div class="space_line row">
							...
							<div class="space_line row">
								<div class="col-lg-12">
									...
									?>
											<a href="<?php echo $e; ?>/cash-receipt/new">
									...
									?>
											<a href="<?php echo $e; ?>/cash-receipt/edit/<?php echo $code; ?>">
